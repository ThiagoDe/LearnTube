...
Comment.create!(body: "That's what I'm talking about...", user_id: user1.id, video_id: vid2.id)
Comment.create!(body: "I can't stop watching you!", user_id: user1.id, video_id: vid3.id)
